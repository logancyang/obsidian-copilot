...
| **Quick Chat tab**                               | Not applicable               | Curates the separate model list used by Quick Chat and Quick Ask. Claude, Codex, and Antigravity account models do not become Quick Chat models.                                                                                                                                                                 |
