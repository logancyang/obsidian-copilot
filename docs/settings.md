...
| **Model (Optional)**     | **Inherit from chat model** | Selects a Quick Chat model for editor and command-palette runs. A slash run uses the current chat's selected model. |
