...
| **Notification sound**             | **On**                       | Plays a short chime whenever an agent stops and wants you: the turn finished, the turn hit an error, or a tool is waiting for your approval. It plays whether or not that chat is the tab you are looking at, so you can leave a long turn running and step away. Turn it off for silent sessions. |
