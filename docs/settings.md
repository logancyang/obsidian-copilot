...
| **Sign in**                                         | Not applicable                           | Shows `codex-acp login`. Run it outside Copilot; the adapter uses the bundled Codex CLI to store that login. There is no key field here.                          |
