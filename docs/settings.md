...
| **Notification sound**             | **On**                       | Plays a short sound whenever an agent stops and wants you: the turn finished, the turn hit an error, or a tool is waiting for your approval. It stays quiet while focus is inside that Agent Chat. Turn it off when you do not want audible notifications.         |
