...
| **Notification sound**             | **On**                       | Plays a short sound whenever an agent stops and wants you: the turn finished, the turn hit an error, or a tool is waiting for your approval. It stays quiet while you are actually watching that chat, and plays when you are looking elsewhere or away from the window, so you can leave a long turn running and step away. |
| **Sound**                          | **Piano key**                | Chooses which sound plays: **Piano key**, **Marimba**, **Bell**, or **Doorbell**. Each one plays as you select it, so you can hear them before deciding. Appears only while **Notification sound** is on.                                                                                                                    |
