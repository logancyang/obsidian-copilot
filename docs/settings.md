...
| **Managed by Copilot**                              | Selected for a new setup                 | Shows the platform, pinned adapter version, and destination. Use **Download & install**, **Reinstall**, or **Uninstall** to manage Copilot's downloaded copies. Installs show progress and an explicit **Cancel** button. No global npm package is changed. |
