...
Links and backlinks do not create rows in any of these empty states. Copilot's working-folder history filters Relevant Notes after Miyo returns candidates.
