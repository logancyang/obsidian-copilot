...
- For Codex, choose an effort when saving a specific default model. The choice is saved after you select an effort. To let Codex choose both model and effort, set **Default model** to **Agent default**.
