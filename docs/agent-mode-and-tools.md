...
- For Codex, **Agent default** leaves the effort choice to the adapter. If an older adapter cannot switch models without an explicit effort, choose an effort or update the adapter. Copilot does not guess an effort.
