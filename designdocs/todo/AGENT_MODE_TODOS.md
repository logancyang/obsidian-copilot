...
- [ ] P0: effort is not passed to claude code correctly on first load if not making any changes
- [ ] P0: Test Windows devices
- [x] P1: Provide copilot specific system prompt
- [ ] P1: Make sure bash command shows what command it runs
- [ ] P1: Make bash tool call show more details
- [x] P1: Queue messages
...
- [x] P1: Agent mode selector (yolo, plan, safe) - https://agentclientprotocol.com/protocol/session-config-options
  - [ ] P1: Basic functionality is added but doesn't work well yet. Need thorough test.
- [x] P1: Merge copilot models with opencode models
  - [ ] P1: How to design the settings to configure the provider?
...
- [ ] P2: [UX] Thought for x second shows 0 second
- [ ] P2: Token counter
