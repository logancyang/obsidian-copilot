...
about), and a link to the daily note it lives in. Older days and the bullets
beyond the first stay on disk. The block tells the agent that the index is a
table of contents, that the linked daily note holds the rest of that
