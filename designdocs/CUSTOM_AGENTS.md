...
| M9  | **Selection by color, not by marker.** Remove the checkmark column from the nested agent list and from the model list in the popover; the selected entry uses the design system's selected-row background and text color, and rows start at the popover's leading content edge. Stories and tests updated. E2E measures the leading-content x of agent rows, model rows, and the select row as equal.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | pending                                                                                                                                                                                                                                                                           |
