...
|    4 | IN PROGRESS | `codex/gallery-bootstrap-step-4` / —          | PASS automated: generated gallery/CSS build; 2 focused suites / 12 tests; full unit suite (368 suites / 5,240 tests); format; lint; clean TypeScript; production build from a missing-generated-file state; gallery bundle has no LangChain marker; production bundle has no gallery/story marker; diff check; imported spec body byte-identical. Generator determinism, nested/path handling, exact four-root counting, exclusions, wired-story bonus handling, and meta-level coverage opt-out are covered. The temporary `src/agentMode/ui/AgentWelcomeCard.stories.tsx` add/build/remove probe discovered the story outside `src/components/ui`, changed covered components 1 → 2 → 1 without an index edit, bundled and then removed its title/content, and left no probe file. Adaptations: the current stacked branch contains 97 presentational components rather than the source plan's 96 snapshot; a tracked declaration plus virtual Jest mock keeps clean-checkout TypeScript/tests valid while the generated runtime index remains ignored; combined root results are deduplicated. Awaiting orchestrator review and vault-pinned live verification/screenshot. |
|    5 | PENDING  | —                                             | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|    6 | PENDING  | —                                             | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|    7 | PENDING  | —                                             | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|    8 | PENDING  | —                                             | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
