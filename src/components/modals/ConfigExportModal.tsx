/**
 * Obsidian Modal shell for exporting Copilot configuration as an encrypted `copilot-config-*.md` file.
...
export class ConfigExportModal extends Modal {
  ...
  onOpen(): void {
    ...
    this.root.render(<ExportStepperContent app={this.app} pluginVersion={this.pluginVersion} />);
  }
