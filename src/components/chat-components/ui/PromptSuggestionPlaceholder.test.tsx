import { PromptSuggestionPlaceholder } from "@/components/chat-components/ui/PromptSuggestionPlaceholder";
...
const FALLBACK = "Ask anything • @ to add context • / for commands";
...
describe("PromptSuggestionPlaceholder", () => {
  describe("PromptSuggestionPlaceholder()", () => {
    ...
    it("shows static guidance without a Tab suggestion for https://github.com/logancyang/obsidian-copilot/issues/3078", () => {
