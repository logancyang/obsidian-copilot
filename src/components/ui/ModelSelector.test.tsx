...
describe("ModelSelector", () => {
  describe("ModelSelector()", () => {
    ...
    it("mounts the dropdown into the caller-provided container instead of the focused window's body (https://github.com/Brevilabs/obsidian-copilot-private/issues/153)", async () => {
