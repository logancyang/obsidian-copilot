...
>(({ className, children, ...props }, ref) => (
  <ScrollAreaPrimitive.Root
    ...
    {...props}
  >
    <ScrollAreaPrimitive.Viewport className="tw-size-full tw-rounded-[inherit]">
      {children}
...
>(({ className, orientation = "vertical", ...props }, ref) => (
  ...
  >
    ...
    <ScrollAreaPrimitive.ScrollAreaThumb className="tw-relative tw-flex-1 tw-rounded-full" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
