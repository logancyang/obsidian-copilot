  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "!tw-h-9 !tw-min-w-[50px] !tw-border tw-border-border tw-border-solid !tw-rounded-md !tw-bg-transparent !tw-px-3 !tw-py-1 md:!tw-text-base !tw-text-sm !tw-transition-colors",
