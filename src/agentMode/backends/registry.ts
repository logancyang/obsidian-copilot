 ...
 * differently in two places. Computed lazily and memoized because reading it at
 * module-eval time would race descriptor imports under some bundler/test load
 * orders (the registry values would not be populated yet).
 */
