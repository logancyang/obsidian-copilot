...
const CODEX_ACP_PINNED_VERSION = "1.10.0";
...
const OUTDATED: InstallState = {
  ...
  message: `Codex adapter v1.9.0 is not supported. Copilot requires Codex adapter v${CODEX_ACP_PINNED_VERSION} or newer.`,
};
...
export const ManagedRetry: StoryObj<CodexConfigViewProps> = {
  ...
  args: {
    managed: {
      ...MANAGED,
      run: { kind: "error", message: "npm was not found. Install Node.js, then retry." },
    },
  },
};
