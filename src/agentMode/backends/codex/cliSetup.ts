 ...
 * Codex CLI: the adapter's binary name and the two commands that get a machine
 * from "no Codex" to "signed in". Kept out of `descriptor.ts` so the dialog can
 * render them without dragging every descriptor dependency into its module graph.
 */
