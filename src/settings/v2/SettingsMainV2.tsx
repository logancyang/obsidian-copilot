...
import { Cog, Command, Cpu, Database, /*Sparkles,*/ Wrench } from "lucide-react"; // Sparkles removed
import React from "react";
import { AdvancedSettings } from "./components/AdvancedSettings";
import { BasicSettings } from "./components/BasicSettings";
// import { CopilotPlusSettings } from "./components/CopilotPlusSettings"; // Plus features disabled
import { ModelSettings } from "./components/ModelSettings";
import { QASettings } from "./components/QASettings";

const TAB_IDS = ["basic", "model", "QA", "command", "advanced"] as const; // "plus" removed
...
const icons: Record<TabId, JSX.Element> = {
  ...
  // plus: <Sparkles className="tw-size-5" />, // Plus features disabled
...
const components: Record<TabId, React.FC> = {
  ...
  // plus: () => <CopilotPlusSettings />, // Plus features disabled
