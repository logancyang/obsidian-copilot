...
const BasicSettings: React.FC<BasicSettingsProps> = ({ indexVaultToVectorStore }) => {
  ...
  const selectProvider = Object.entries(omit(ProviderInfo, excludeProviders));
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <HelpCircle className="h-5 w-5 sm:h-4 sm:w-4 cursor-pointer text-muted-foreground hover:text-accent translate-y-[1px]" />
                  </PopoverTrigger>
                  <PopoverContent
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Popover>
                  ...
                  >
                    <div className="space-y-2 sm:space-y-2.5">
                      {/* Warning Alert */}
                      <div className="rounded bg-yellow-50 border-l-4 border-yellow-400 p-1.5 sm:p-2 dark:bg-yellow-950/50 dark:border-yellow-600">
                        <p className="text-yellow-700 dark:text-yellow-200 text-[11px] sm:text-xs">
                      ...
                      {/* Additional Notes */}
                      <div className="text-[10px] sm:text-[11px] text-muted-foreground space-y-0.5 sm:space-y-1 border-t pt-1.5 sm:pt-2">
                        <p>
