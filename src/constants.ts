...
export const COMMAND_NAMES: Record<CommandId, string> = {
  ...
  [COMMAND_IDS.OPEN_COPILOT_SEARCH]: "Open Copilot search",
  ...
  [COMMAND_IDS.SUGGEST_TAGS]: "Suggest tags for current note",
...
export const DEFAULT_SETTINGS: CopilotSettings = {
  ...
  suggestTagsOnPropertyFocus: true,
