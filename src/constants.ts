...
export const COMPOSER_OUTPUT_INSTRUCTIONS = `Return the new note content or canvas JSON in a special XML format.
  ...
  <content>The FULL CONTENT of the md note goes here</content>
  </writeToFile>
  ...
  * When generating changes on multiple files, output multiple XML objects
  * For canvas files:
