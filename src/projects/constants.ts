...
/**
 * Latest projects storage version.
 * - 0: legacy (data.json settings.projectList only)
 * - 1: vault files (projectsFolder/\{id\}/project.md)
 */
export const PROJECTS_STORAGE_VERSION_LATEST = 1;
